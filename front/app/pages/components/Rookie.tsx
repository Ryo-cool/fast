          ...
          <div className="p-4">
              <div className="text-center mb-4 opacity-90">
                  <a href="#" className="block relative">
                      <img alt="profile" src="/images/person/1.jpg" className="mx-auto object-cover rounded-full h-40 w-40 "/>
                  </a>
              </div>
              <div className="text-center">
                  ...
                  <p className="text-md text-gray-500 dark:text-gray-400 max-w-xs py-4 font-light">
                      Patrick Sebastian, born November 14, 1953 in Brive-la-Gaillarde, is an imitator.
                  </p>
              </div>
